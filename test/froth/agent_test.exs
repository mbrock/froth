defmodule Froth.Agent.WorkerTest do
  ...
  test "prices GPT-5.6 Terra usage at the documented per-request tiers" do
    short_cycle = Repo.insert!(%Cycle{model: "gpt-5.6-terra", cost_usd: 0.0})
    ...
    assert_in_delta short_cycle.cost_usd, 0.2912, 1.0e-9

    long_cycle = Repo.insert!(%Cycle{model: "gpt-5.6-terra", cost_usd: 0.0})
    ...
    assert_in_delta long_cycle.cost_usd, 1.2380004, 1.0e-9

    multi_request_cycle =
      Repo.insert!(%Cycle{model: "gpt-5.6-terra", cost_usd: 0.0})
    ...
    assert_in_delta multi_request_cycle.cost_usd, 0.8, 1.0e-9
  end
