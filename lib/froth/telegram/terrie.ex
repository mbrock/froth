defmodule Froth.Telegram.Terrie do
  @moduledoc """
  Terrie bot profile: an independent GPT-5.6 Terra identity sharing Froth's
  chronicle, tools, and generic Telegram runtime with Charlie and Luna.
  """
