defmodule Froth.Telegram.Lennart do
  @moduledoc """
  Lennart bot profile — Gothenburg reggae stoner, ported from Python to BEAM.
  ...
  alias Froth.Telegram.Toolsets.Lennart, as: LennartTools
  ...
  def child_spec(opts) do
    %{
      id: {__MODULE__, opts[:id] || opts["id"] || "lennart"},
