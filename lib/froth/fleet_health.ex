defmodule Froth.FleetHealth do
  ...
  @hosts [
    %{id: "charlie", name: "Charlie", host: "charlie.1.foo", ip: "37.27.71.35", region: "Falkenstein", sleep: false},
    %{id: "walter", name: "Walter", host: "walter.1.foo", ip: "34.57.46.219", region: "Chicago", sleep: false},
    %{id: "walterjr", name: "Walter Jr", host: "walter-jr.1.foo", ip: "34.159.254.83", region: "Frankfurt", sleep: false},
    %{id: "matilda", name: "Matilda", host: "matilda.1.foo", ip: "34.51.254.133", region: "Stockholm", sleep: false},
    %{id: "kirk", name: "Cpt Kirk", host: "captain-kirk.1.foo", ip: "34.64.37.15", region: "Seoul", sleep: false},
    %{id: "vault", name: "Vault", host: "vault.1.foo", ip: "34.170.164.0", region: "Chicago", sleep: false},
    %{id: "amy", name: "Amy HQ", host: "amy.1.foo", ip: "34.68.65.185", region: "Chicago", sleep: true},
    %{id: "amyisrael", name: "Amy Israel", host: "amy-israel.1.foo", ip: "34.165.115.203", region: "Iowa", sleep: true},
    %{id: "lennart", name: "Lennart", host: "charlie.1.foo", ip: "37.27.71.35", region: "Falkenstein", sleep: false, mirrors: "charlie"},
    %{id: "bertil", name: "Bertil", host: "vault.1.foo", ip: "—", region: "Vault", sleep: true},
    %{id: "tototo", name: "Tototo", host: "walter-jr.1.foo", ip: "—", region: "Parasitic", sleep: false, mirrors: "walterjr"},
  ]
  ...
  defp write_json(results) do
    resolved = Enum.map(results, fn {id, host} ->
      case host do
        %{mirrors: mirror_id} ->
