defmodule LLM.Providers.Fake do
  @moduledoc """
  ...
  intercepted in `LLM.stream/3` and delegated to
  `LLM.Fake.stream/2` before the real provider callbacks
  ...
  `LLM.stream/3` be a plain pattern match, with no special
